...
public class EMnjj
 ...
 /** globally replace missing values */
   ...
   **/
  private void EMnjj_Init (Instances inst)
    throws Exception {
    int i, j, k;
...
//  private void EM_Report (Instances inst) {
  public void EMnjj_Report (Instances inst) {
    int i, j, l, m;
    System.out.println("======================================");
...
//				}
  ...
  public static void main (String[] argv) throws Exception {
		...
		AppendToFile.appendMethodB("D:/fen3Result/EM.txt", "name,\tTime,\tNewTime\r\n");
		
		File file = new File("D:/dataset/");
		File[] lf = file.listFiles();
		for (int ii = 0; ii < lf.length; ii++) {
			System.out.print(lf[ii].getName()+"\t\t");
			AppendToFile.appendMethodA("D:/fen3Result/EM.txt", lf[ii].getName()+",");
...
//			String aa2 = dataset.instance(2).stringValue(1);
			...
			long time=end-st;
			AppendToFile.appendMethodA("D:/fen3Result/EM.txt", time + ",");
...
//-------------------------------------------------------------------------------------------			
//			System.out.print("\nfen3Result\n");		
			File f2 = new File("D:/fen3Result/" + lf[ii].getName());
			long len = f2.length();
			if(len==0){
				System.out.print("file is empty!"+"\n\n");
			}
			else {
				Instances data = generateData("D:/fen3Result/"
						+ lf[ii].getName());
