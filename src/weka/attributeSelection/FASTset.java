...
import weka.filters.supervised.attribute.fastguiset;
...
//    return "";
////    "Specify the number of attributes to retain. The default value "
...
//  }
  ...
  public void setminF_Correlation(double n) {
	  minF_Correlation = n;
	  }
...
//    return "";
////    "A constant option. FCBF is capable of generating"
////      +" attribute rankings.";
//  }
...
//    return "";
////    "Specify a set of attributes to ignore. "
...
//    }
  ...
  public int[] search (ASEvaluation ASEval, Instances data)
    throws Exception {
	  int[] a={1,2};
    int i, j;
    fastguiset fast = new fastguiset();
    fast.setInputFormat(data);
    fast.setkth(K);
    fast.setThij(minF_Correlation);
    Instances reduced = Filter.useFilter(data, fast);
    String buf = fast.getnjjbuf();
    return a;
//    rankedAttributes = fast.getM_SelectedAttributes();
