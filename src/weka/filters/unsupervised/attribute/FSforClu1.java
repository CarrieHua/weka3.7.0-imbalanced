 ...
 */
public class FSforClu1 extends Filter implements SupervisedFilter, OptionHandler {
...
//			
//			System.out.print(njjFeatureNum+"\t");
			...
			disData1 = Filter.useFilter(disData, m_Filter2);  //removeFSforClu;	
				njjData	=disData1;
			int  njjFeatureNum = njjData.numAttributes() - 1;		
			System.out.print("disData1 numF:"+disData1.numAttributes()+"\t");
			System.out.print("disData1 numI:"+disData1.numInstances()+"\n");
			...
			System.out.print("data1 numF:"+data1.numAttributes()+"\t");
			System.out.print("data1 numI:"+data1.numInstances()+"\n");
			...
			System.out.print("datas numF:"+data1sample.numAttributes()+"\t");
			System.out.print("datas numI:"+data1sample.numInstances()+"\n");
