 ...
 */
public class NjjPrim extends Filter implements SupervisedFilter, OptionHandler {
...
//				System.out.println(GG[q]);
			...
			long time=end-st;
			 AppendToFile.appendMethodA("D:/exp/njj/Time_njj.txt", time+"\r\n");
...
//				System.out.println(GG[i]);
	...
	public static void main(String[] argv) {
		File file = new File("D:/exp/njj/17njj");
		AppendToFile.appendMethodB("D:/exp/njj/Time_njj.txt", " ");
...
//				continue;
//			else {
				 AppendToFile.appendMethodA("D:/exp/njj/Time_njj.txt", lf[i].getName()+",\t");

			 for(int k=15;k<16;k=k+5){
				 for(int p=15;p<16;p=p+5){
...
//						"-k",String.valueOf(k),
//						"-p",String.valueOf(p),
						"-i", "D:/exp/njj/17njj/" + lf[i].getName(), 
						"-o", "D:/exp/njj/NJJ1/"+k+"_"+p+"_"+ lf[i].getName()	
						};
				runFilter(new NjjPrim(), arg);
//			}
		}
	}}}
}
