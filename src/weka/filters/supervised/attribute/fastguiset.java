 ...
 */
public class fastguiset extends Filter implements SupervisedFilter, OptionHandler {
	...
	public String njjbuf="\n";
	
	public String getnjjbuf(){
		 return njjbuf;
	 }
	// ============================================================================
	public int kth=5;
	public double Thij=0.1;
//
//	//	
	 public void setkth (int c){
		 kth=c;
...
//		}
		...
		// =========================================================================
		 ...
		 setkth(Integer.valueOf(perString2).intValue());
		 
		 String perString1 = Utils.getOption('p', options);
		 if (perString1.length() == 0)
		 setThij(0.1);
		 else
		 setThij(Double.valueOf(perString1).intValue());
...
//			yuzhi=(int)(njjFeatureNum*yuzhi2/yuzhi1);  //filter yuzhi=N/logN base 2
			...
			njjbuf=(njjbuf+"K = "+String.valueOf(yuzhi)+"\n");
			njjbuf=(njjbuf+"minT-Relevance = "+String.valueOf(1-suic[ranked[yuzhi]])+"\n");
...
//			double Thij=(suijave[0]+suicave)/2.0;
			njjbuf=(njjbuf+"minF-Correlation = "+String.valueOf(Thij)+"\n");
...
//			System.out.println(clusterNum+"\t");
			...
			njjbuf=(njjbuf+"\nSelected attributes: ");
			for (int njjb=0;njjb<clusterNum-1;njjb++){
				njjbuf=(njjbuf+String.valueOf(GG[njjb])+",");
			}
			njjbuf=(njjbuf+String.valueOf(GG[clusterNum-1]));
			njjbuf=(njjbuf+" : "+String.valueOf(clusterNum));
