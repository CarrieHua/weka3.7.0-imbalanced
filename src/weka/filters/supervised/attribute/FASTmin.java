 ...
 */
public class FASTmin extends Filter implements SupervisedFilter, OptionHandler {
...
//			AppendToFile.appendMethodA("result/NJJ/Time.txt", ","+clusterNum+","+data.numAttributes()+","+njjData.numAttributes()+",");
			...
			m_OutputFormat.setRelationName(",FASTmin,"+ data.numAttributes()+ "," +njjData.numAttributes()+","+yuzhi+","+clusterNum);
			// Convert pending input instances
			for (int i = 0; i <njjData.numInstances(); i++) {
				convertInstancenjj(njjData.instance(i), GG, clusterNum);
			}
			AppendToFile.appendMethodA("D:/FASTmin/T.txt", ","+data.numAttributes()+ "," +njjData.numAttributes()+","+yuzhi+","+clusterNum+","+yu+",");
...
//		setSearch(new BestFirst());
	...
	public static void main(String[] argv) {
		...
		AppendToFile.appendMethodB("D:/FASTmin/T.txt", " ");
...
//					"-S", "weka.attributeSelection.BestFirst -S 8",
					...
					"-o", "D:/FASTmin/" + lf[i].getName()
			};
			AppendToFile.appendMethodA("D:/FASTmin/T.txt", lf[i].getName());
			long st =System.currentTimeMillis();
			runFilter(new FASTmin(), arg);
			long end =System.currentTimeMillis();
			long time=end-st;
			AppendToFile.appendMethodA("D:/FASTmin/T.txt", time + "\r\n");
		}
	}
}
