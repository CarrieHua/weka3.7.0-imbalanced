 ...
 */
public class FS extends Filter implements SupervisedFilter, OptionHandler {
	...
	public static void main(String[] argv) {
		...
		for (int i = 0; i < lf.length; i++) {
			...
			String[] arg = {
					...
					"-i", "dataset/" + lf[i].getName(), 
					"-o", "result/NJJ/" +lf[i].getName()
			};
			AppendToFile.appendMethodA("result/NJJ/Time.txt", lf[i].getName());
			...
			String[] arg1 ={
				...
				"-o", "result/FCBF/" + lf[i].getName()};
			AppendToFile.appendMethodA("result/FCBF/Time.txt",lf[i].getName());
