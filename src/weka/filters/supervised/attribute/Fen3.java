...
public class Fen3 extends Filter implements SupervisedFilter, OptionHandler {
	...
	public boolean batchFinished() throws Exception {
		...
		if (!isOutputFormatDefined()) {
			...
			AppendToFile.appendMethodA("D:/fen3Result/Time.txt", data.numInstances()+","+N+",");
...
//----Nominal data set			
			if((CountNum < x || CountNum < S) && (CountNom >= x && CountNom >= S)){
				...
				AppendToFile.appendMethodA("D:/fen3Result/Time.txt", "Nom"+","+S+","+x+",");
...
//-------------------------------------------------------------------------------
				...
				AppendToFile.appendMethodA("D:/fen3Result/Time.txt", "Num"+","+S+","+x+",");
...
//-------------------------------------------------------------------
				...
				AppendToFile.appendMethodA("D:/fen3Result/Time.txt", "Mix"+","+S+","+x+",");
				yNom = (CountNom-1)/x + 1;
				...
				AppendToFile.appendMethodA("D:/fen3Result/Time.txt", "FALSE!"+",");
				return false;
			}
			...
			m_OutputFormat.setRelationName(y+",Fen3,"+ data.numAttributes()+ "," +data.relationName() );
			// Convert pending input instances
			for (int i = 0; i <data.numInstances(); i++) {
				convertInstancenjj(data.instance(i), GG, y);
			}
			AppendToFile.appendMethodA("D:/fen3Result/Time.txt", y+",");
...
//		setSearch(new BestFirst());
	...
	public static void main(String[] argv) {
		...
		AppendToFile.appendMethodB("D:/fen3Result/Time.txt", "name,\tI,\tF,\tcatg,\tS,\tx,\tnewF,\tFenTime\r\n");
...
//					"-S", "weka.attributeSelection.BestFirst -S 8",
					...
					"-o", "D:/fen3Result/" + lf[i].getName()
			};
			AppendToFile.appendMethodA("D:/fen3Result/Time.txt", lf[i].getName()+",");
			long st =System.currentTimeMillis();
			runFilter(new Fen3(), arg);
			long end =System.currentTimeMillis();
			long time=end-st;
			AppendToFile.appendMethodA("D:/fen3Result/Time.txt", time + "\r\n");
		}
	}
