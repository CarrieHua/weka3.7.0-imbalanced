 ...
 */
public class FASTdefault extends Filter implements SupervisedFilter, OptionHandler {
...
//			AppendToFile.appendMethodA("result/NJJ/Time.txt", ","+clusterNum+","+data.numAttributes()+","+njjData.numAttributes()+",");
			...
			AppendToFile.appendMethodA("D:/njj/Time7.txt", ","+data.numAttributes()+ "," +clusterNum+","+name+",");
