 ...
 */
public class FASTbTrue extends Filter implements SupervisedFilter, OptionHandler {
...
//			}
			...
			m_OutputFormat.setRelationName("FASTbTrue,"+ data.relationName()+","+yuzhi1SU+","  );
			for (int i = 0; i <njjData.numInstances(); i++) {
				convertInstancenjj(njjData.instance(i), retained, sf);
			}
			AppendToFile.appendMethodA("D:/FASTbTrue/Time.txt", ","+data.relationName()+","+data.numAttributes()+","+njjData.numAttributes()+","+yuzhi+","+sf+","+data.numInstances()+","+data.numClasses()+","+yuzhi1SU+",");
...
//		setSearch(new BestFirst());
	...
	public static void main(String[] argv) {
		...
		AppendToFile.appendMethodB("D:/FASTbTrue/Time.txt", " ");
...
//					"-S", "weka.attributeSelection.BestFirst -S 8",
					...
					"-o", "D:/FASTbTrue/" + lf[i].getName()
			};
			AppendToFile.appendMethodA("D:/FASTbTrue/Time.txt", lf[i].getName());
			long st =System.currentTimeMillis();
			runFilter(new FASTbTrue(), arg);
			long end =System.currentTimeMillis();
			long time=end-st;
			AppendToFile.appendMethodA("D:/FASTbTrue/Time.txt", time + "\r\n");
		}
	}
