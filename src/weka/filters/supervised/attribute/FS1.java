 ...
 */
public class FS1 extends Filter implements SupervisedFilter, OptionHandler {
...
//			System.out.println(clusterNum+"\t");
			...
			m_OutputFormat.setRelationName(clusterNum+","+ data.numAttributes()+ ",NJJ"  +name  );
...
//		AppendToFile.appendMethodB("result/NJJ/Time.txt", "NJJ\r\ndataset-seleFea-OrgFea-disFea-Time\r\n");
//		AppendToFile.appendMethodB("result/FCBF/Time.txt", "FCBF\r\ndataset-seleFea-OrgFea--Time\r\n");	
...
//					"-o", "result/NJJ/"  +argv[0]
//			};
//			AppendToFile.appendMethodA("result/NJJ/Time.txt", argv[0]);
//			long st =System.currentTimeMillis();
//			runFilter(new njj7(), arg);
//			long end =System.currentTimeMillis();
//			long time=end-st;
//			AppendToFile.appendMethodA("result/NJJ/Time.txt", time + "\r\n");
//			
//			
//			
//			System.out.println("FCBF");		
//			String[] arg1 ={
//					"-i", "dataset/" + argv[0], 
//					"-c","last",
//
//				"-E","weka.attributeSelection.SymmetricalUncertAttributeSetEval ",
//				"-S","weka.attributeSelection.FCBFSearch -D false -T -1.7976931348623157E308 -N -1",							
//				"-o", "result/FCBF/" +argv[0]
//				                                   };
//			AppendToFile.appendMethodA("result/FCBF/Time.txt",argv[0]);
//			st=System.currentTimeMillis();
//			runFilter(new AttributeSelection(), arg1);
//			end=System.currentTimeMillis();
//			time=end-st;			
//			AppendToFile.appendMethodA("result/FCBF/Time.txt",time+"\r\n");
			...
			AppendToFile.appendMethodA("result/CFS/Time.txt", argv[0]);
			long st =System.currentTimeMillis();
			runFilter(new CFS(), arg2);
			long end =System.currentTimeMillis();
			long time=end-st;
			AppendToFile.appendMethodA("result/CFS/Time.txt", time + "\r\n");
			
			
			System.out.println("ReliefF");
			String[] arg3 = {
					"-E","weka.attributeSelection.ReliefFAttributeEval -M 30 -D 1 -K 5",
					"-S","weka.attributeSelection.Ranker -T 0.45 -N -1",
					"-c", "last",

					"-i", "dataset/" + argv[0], 
					"-o", "result/ReliefF/" +argv[0]
			};
			AppendToFile.appendMethodA("result/ReliefF/Time.txt", argv[0]);
			st =System.currentTimeMillis();
			runFilter(new ReliefF(), arg3);
			end =System.currentTimeMillis();
			time=end-st;
			AppendToFile.appendMethodA("result/ReliefF/Time.txt", time + "\r\n");
