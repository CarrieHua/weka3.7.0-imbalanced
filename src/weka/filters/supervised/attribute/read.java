 ...
 */
public class read extends Filter implements SupervisedFilter, OptionHandler {
...
//					father[jj] = jj;
	...
	public boolean batchFinished() throws Exception {
		...
		if (!isOutputFormatDefined()) {
			...
			Instances njjData = getInputFormat(); //input the train dataset
			
			int njjFeatureNum = njjData.numAttributes() - 1;		
			
		
			AppendToFile.appendMethodA("D:/exp/0609/fNum-FOCUS.txt", ","+njjData.numAttributes()+",\t\n");
			// *****************************
...
//			}
	...
	public static void main(String[] argv) {
		...
		AppendToFile.appendMethodB("D:/exp/0609/fNum-FOCUS.txt", " ");
		...
		for (int i = 0; i < lf.length; i++) {
			...
			String[] arg = {
					...
					"-i", "D:/exp/0609/高性能/FOCUS/" + lf[i].getName(), 
					"-o", "D:/exp/njj7/" + lf[i].getName()
			};
			AppendToFile.appendMethodA("D:/exp/0609/fNum-FOCUS.txt", lf[i].getName());
//			runFilter(new read(), arg);
