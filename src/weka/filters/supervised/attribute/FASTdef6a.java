 ...
 */
public class FASTdef6a extends Filter implements SupervisedFilter, OptionHandler {
...
//			}
			...
			m_OutputFormat.setRelationName("FASTdef6a,"+ data.relationName()+","+yuzhi1SU+","  );
			for (int i = 0; i <njjData.numInstances(); i++) {
				convertInstancenjj(njjData.instance(i), GGG, sf);
			}
			AppendToFile.appendMethodA("D:/FASTdef6a/Time.txt", ","+data.relationName()+","+data.numAttributes()+","+njjData.numAttributes()+","+yuzhi+","+sf+","+data.numInstances()+","+data.numClasses()+","+yuzhi1SU+",");
...
//		setSearch(new BestFirst());
	...
	public static void main(String[] argv) {
		...
		AppendToFile.appendMethodB("D:/FASTdef6a/Time.txt", " ");
...
//					"-S", "weka.attributeSelection.BestFirst -S 8",
					...
					"-o", "D:/FASTdef6a/" + lf[i].getName()
			};
			AppendToFile.appendMethodA("D:/FASTdef6a/Time.txt", lf[i].getName());
			long st =System.currentTimeMillis();
			runFilter(new FASTdef6a(), arg);
			long end =System.currentTimeMillis();
			long time=end-st;
			AppendToFile.appendMethodA("D:/FASTdef6a/Time.txt", time + "\r\n");
		}
	}
