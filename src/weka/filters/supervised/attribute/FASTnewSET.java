 ...
 */
public class FASTnewSET extends Filter implements SupervisedFilter, OptionHandler {
...
//				if (suij[i][jj] < Thij) {
				...
				if (suij[i][jj] < 1-suic[i]||suij[i][jj]<1-suic[jj]) {
...
//			m_OutputFormat.setRelationName(clusterNum+",-7-,"+ data.numAttributes()+ "," +name  );
			m_OutputFormat.setRelationName("BFS2,"+yuzhi+","+ data.relationName()+"," );
