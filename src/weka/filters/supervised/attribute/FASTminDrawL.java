 ...
 */
public class FASTminDrawL extends Filter implements SupervisedFilter, OptionHandler {
...
//			Filter m_Filter = new weka.filters.supervised.attribute.njjDiscretizeTrue();
			...
			njjData = Filter.useFilter(data, m_Filter);  //discretize			
...
//			AppendToFile.appendMethodA("result/NJJ/Time.txt", ","+clusterNum+","+data.numAttributes()+","+njjData.numAttributes()+",");
			...
			AppendToFile.appendMethodA("D:/FASTminDrawL/T.txt", ","+data.numAttributes()+ ","+Y+"," +njjData.numAttributes()+","+yuzhi+","+clusterNum+",");
