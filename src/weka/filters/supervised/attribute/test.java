 ...
 */
public class test extends Filter implements SupervisedFilter, OptionHandler {
...
//			double Thij=m_Th/10;
			...
			AppendToFile.appendMethodA("D:/exp/njj/test.txt", name+","+clusterNum+","+njjData.numAttributes()+ ","+time + "\r\n");
...
//		File file = new File("D:/exp/njj/bigDSlala/");
		File file = new File("D:/exp/njj/test/");
		
		AppendToFile.appendMethodB("D:/exp/njj/test.txt", " ");
...
//					"-i", "D:/exp/njj/bigDSlala/" + lf[i].getName(), "-o",
					"-i", "D:/exp/njj/test/" + lf[i].getName(), "-o",
					
//					"D:/exp/njj/NJJbigDS/" + lf[i].getName()
					"D:/exp/njj/newtest/" + lf[i].getName()
			};
			runFilter(new test(), arg);
		}
	}
}
