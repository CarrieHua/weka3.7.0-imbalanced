 ...
 */
public class FASTb15 extends Filter implements SupervisedFilter, OptionHandler {
...
//			}
			...
			m_OutputFormat.setRelationName("FASTb15,"+ data.relationName()+","+yuzhi1SU+","  );
			for (int i = 0; i <njjData.numInstances(); i++) {
				convertInstancenjj(njjData.instance(i), retained, sf);
			}
			AppendToFile.appendMethodA("D:/FASTb15/Time.txt", ","+data.relationName()+","+data.numAttributes()+","+njjData.numAttributes()+","+yuzhi+","+sf+","+data.numInstances()+","+data.numClasses()+","+yuzhi1SU+",");
...
//		setSearch(new BestFirst());
	...
	public static void main(String[] argv) {
		...
		AppendToFile.appendMethodB("D:/FASTb15/Time.txt", " ");
...
//					"-S", "weka.attributeSelection.BestFirst -S 8",
					...
					"-o", "D:/FASTb15/" + lf[i].getName()
			};
			AppendToFile.appendMethodA("D:/FASTb15/Time.txt", lf[i].getName());
			long st =System.currentTimeMillis();
			runFilter(new FASTb15(), arg);
			long end =System.currentTimeMillis();
			long time=end-st;
			AppendToFile.appendMethodA("D:/FASTb15/Time.txt", time + "\r\n");
		}
	}
