 ...
 */
public class njjPrim4 extends Filter implements SupervisedFilter, OptionHandler {
...
//			double m_Th=0.189483956+0.344195217*SUic;//1
//			double m_Th=0.045800198+1.234271765*SUic;//2
			double m_Th=0.048993587+1.307435513*SUic;//3
//			double m_Th=0.050284881+1.342396379*SUic;//4
//			double m_Th=0.120578595+1.090041280*SUic;//5
...
//			tree.displayAdjList();
			...
			AppendToFile.appendMethodA("D:/exp/njj/njjPrim3.txt", name+","+clusterNum+","+njjData.numAttributes()+ ","+time + "\r\n");
...
//				for (int k = 60; k < 91; k = k + 1) {// the little the more
					String[] arg = {
							"-E",
...
//							String.valueOf(p),
							...
							"-o",
							"D:/exp/njj/newdataset/" + "_"+ lf[i].getName()
					// "-o", "D:/exp/njj/newdataset/"+"__"+ lf[i].getName()
					};
					runFilter(new njjPrim4(), arg);
				}
//			}
//		}
	}
