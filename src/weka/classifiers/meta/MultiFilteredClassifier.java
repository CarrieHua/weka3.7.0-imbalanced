 ...
 */
public class MultiFilteredClassifier 
   ...
   * Default constructor.
   */
  public MultiFilteredClassifier() {

    m_Classifier = new weka.classifiers.meta.AttributeSelectedClassifier();
    m_Filter = new weka.filters.szb.BalanceClass();
  }
  ...
  public double [] distributionForInstance(Instance instance)
    ...
    */
    ...
    double Dis_result[]=m_Classifier.distributionForInstance(newInstance);
    double[] result=new double[2];
    result[0]=Dis_result[0];
    for(int i=1;i<Dis_result.length;i++)
    {
    	if(result[1]<=Dis_result[i])
       {
    		result[1]=Dis_result[i];
    	         }
    }
  ...
  public static void main(String [] argv) {
    runClassifier(new MultiFilteredClassifier(), argv);
  }
}
