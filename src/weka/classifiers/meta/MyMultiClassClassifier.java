 ...
 */
public class MyMultiClassClassifier 
	  ...
	  int[] pair = range.getSelection();
          if (m_pairwiseCoupling && inst.numClasses() > 2) {
            ...
            if (current[0] > current[1]) {
              probs[pair[1]] =probs[pair[1]]-1.0;
            } else {
              probs[pair[0]] =probs[pair[0]]-1.0;
            }
          }
        }
      }
      if (m_pairwiseCoupling && inst.numClasses() > 2) {
        //return pairwiseCoupling1(n, r);
       return pairwiseCoupling2(n,r);
      }
    } else {
  ...
  public static void main(String [] argv) {
    runClassifier(new MyMultiClassClassifier(), argv);
  }
}
