...
public class AttributeSelectedClassifier 
  ...
  protected ASEvaluation m_Evaluator = 
    new weka.attributeSelection.WrapperSubsetEval();
  ...
  public AttributeSelectedClassifier() {
    m_Classifier = new weka.classifiers.meta.MultiClassClassifier();
  }
  ...
  public void buildClassifier(Instances data) throws Exception {
    ...
    int []attrs = m_AttributeSelection.selectedAttributes();
