...
public class UnderBagging2
  ...
  public String ensembleType = "UNDERBAGGING2";
...
/*    if (m_attribSelection){
    ...
    for (int i = 0; i < m_Classifiers.length; i++) {   
      Instances sampleData = randomSampling(newData, majC, minC, nMin, nMin);
      m_Instances[i]=new Instances(sampleData);
      getClassifier(i).buildClassifier(sampleData);
      //m_Classifiers[i].buildClassifier(sampleData);
    }
  }
  ...
  public static void main(String [] argv) {
    runClassifier(new UnderBagging2(), argv);
  }
}
