 ...
 */
public class RUSBoostM1 extends RandomizableIteratedSingleClassifierEnhancer
	...
	protected void buildClassifierUsingResampling(Instances data)
		...
		for (m_NumIterationsPerformed = 0; m_NumIterationsPerformed < m_Classifiers.length; m_NumIterationsPerformed++) {
			...
			do{
				...
				MyUnderSample myus = new MyUnderSample();
				myus.setInputFormat(sample);
				sampleTraining = Filter.useFilter(sample, myus);
	...
	public static void main(String[] argv) {
		runClassifier(new RUSBoostM1(), argv);
	}
}
