...
public class MxNFolds {
	...
	private static String[] commonDatasets = { "ant" };
	...
	public String crossValidate(Classifier c) throws Exception {
		...
		double balance = 0;
		double mcc = 0;
		double nonPrecision = 0;
		double nonFMeasure = 0;
		...
		for (int i = 0; i < m_repeat; i++) {
			...
			for (int j = 0; j < m_folds; j++) {
				...
				G_mean += Math.sqrt(eval.trueNegativeRate(0) * eval.truePositiveRate(0));
				recall += eval.recall(0);
				precision += eval.precision(0);
				nonPrecision += eval.nonPrecision(0);

				F_measure += eval.fMeasure(0);
				nonFMeasure += eval.nonFMeasure(0);
		...
		nonFMeasure = nonFMeasure / m_repeat / m_folds;
		recall = recall / m_repeat / m_folds;
		precision = precision / m_repeat / m_folds;
		nonPrecision = nonPrecision / m_repeat / m_folds;
		...
		String result = Utils.doubleToString(auc, 4) + "," // 1
				...
				+ Utils.doubleToString(nonPrecision, 4) + "," // 13
				+ Utils.doubleToString(nonFMeasure, 4); // 14
		return result;
	}
	...
	public static void countDataProperty() {
		 ...
		 */
		String datasets[] = { "ecoli-0_vs_1", "ecoli1", "ecoli2", "ecoli3", "glass-0-1-2-3_vs_4-5-6", "glass0",
				"glass1", "glass6", "haberman", "iris0", "new-thyroid1", "newthyroid2", "page-blocks0", "pima",
				"segment0", "vehicle0", "vehicle1", "vehicle2", "vehicle3", "wisconsin", "yeast1", "yeast3",
				"abalone19", "abalone9-18", "ecoli-0-1-3-7_vs_2-6", "ecoli4", "glass-0-1-6_vs_2", "glass-0-1-6_vs_5",
				"glass2", "glass4", "glass5", "page-blocks-1-3_vs_4", "shuttle-c0-vs-c4", "shuttle-c2-vs-c4", "vowel0",
				"yeast-0-5-6-7-9_vs_4", "yeast-1-2-8-9_vs_7", "yeast-1-4-5-8_vs_7", "yeast-1_vs_7", "yeast-2_vs_4",
				"yeast-2_vs_8", "yeast4", "yeast5", "yeast6", "cleveland-0_vs_4", "ecoli-0-1-4-6_vs_5",
				"ecoli-0-1-4-7_vs_2-3-5-6", "ecoli-0-1-4-7_vs_5-6", "ecoli-0-1_vs_2-3-5", "ecoli-0-1_vs_5",
				"ecoli-0-2-3-4_vs_5", "ecoli-0-2-6-7_vs_3-5", "ecoli-0-3-4-6_vs_5", "ecoli-0-3-4-7_vs_5-6",
				"ecoli-0-3-4_vs_5", "ecoli-0-4-6_vs_5", "ecoli-0-6-7_vs_3-5", "ecoli-0-6-7_vs_5", "glass-0-1-4-6_vs_2",
				"glass-0-1-5_vs_2", "glass-0-4_vs_5", "glass-0-6_vs_5", "led7digit-0-2-4-5-6-7-8-9_vs_1",
				"yeast-0-2-5-6_vs_3-7-8-9", "yeast-0-2-5-7-9_vs_3-6-8", "yeast-0-3-5-9_vs_7-8" };
		...
		String content = "Data" + "," + "Minority" + "," + "Majority" + "," + "Sum" + "," + "Attributes" + "," + "Ratio"
				+ "\n";
		...
		for (int i = 0; i < datasets.length; i++) {
			...
			try {
				...
				content = datasets[i] + "," + min + "," + max + "," + sum + "," + attr + "," + ratio + "\n";
				outputResults(destName, content);
	...
	public static void evalCFSBench() {
		...
		String datasets[] = { "CM1", "JM1", "KC1", "KC3", "MC1", "MC2", "MW1", "PC1", "PC2", "PC3", "PC4", "PC5" };
		...
		for (int i = 0; i < models.length; i++) {
			...
			for (int j = 0; j < datasets.length; j++) {
				...
				content = content + "," + Utils.doubleToString(time / 1000.0, 4) + "\n";
				outputResults(destName, content);
			}
		}
	}
	...
	public static void evalMetaCost() {
		...
		for (int i = 0; i < models.length; i++) {
			...
			for (int j = 0; j < datasets.length; j++) {
				...
				String content = "";
				try {
					content += datasets[j] + "," + mxn.metacostValidate(models[i]);
				} catch (Exception e) {
					e.printStackTrace();
				}
				long time = System.currentTimeMillis() - timeStart;
	...
	public static void evalEasyEnsemble() {
		...
		String datasets[] = { "yeast3", "ecoli3", "page-blocks0", "ecoli-0-3-4_vs_5", "yeast-2_vs_4",
				"ecoli-0-6-7_vs_3-5", "ecoli-0-2-3-4_vs_5", "glass-0-1-5_vs_2", "yeast-0-3-5-9_vs_7-8",
				"yeast-0-2-5-6_vs_3-7-8-9", "yeast-0-2-5-7-9_vs_3-6-8", "ecoli-0-4-6_vs_5", "ecoli-0-1_vs_2-3-5",
				"ecoli-0-2-6-7_vs_3-5", "glass-0-4_vs_5", "ecoli-0-3-4-6_vs_5", "ecoli-0-3-4-7_vs_5-6",
				"yeast-0-5-6-7-9_vs_4", "vowel0", "ecoli-0-6-7_vs_5", "glass-0-1-6_vs_2", "ecoli-0-1-4-7_vs_2-3-5-6",
				"led7digit-0-2-4-5-6-7-8-9_vs_1", "ecoli-0-1_vs_5", "glass-0-6_vs_5", "glass-0-1-4-6_vs_2", "glass2",
				"ecoli-0-1-4-7_vs_5-6", "cleveland-0_vs_4", "ecoli-0-1-4-6_vs_5", "shuttle-c0-vs-c4", "yeast-1_vs_7",
				"glass4", "ecoli4", "page-blocks-1-3_vs_4", "abalone9-18", "glass-0-1-6_vs_5", "shuttle-c2-vs-c4",
				"yeast-1-4-5-8_vs_7", "glass5", "yeast-2_vs_8", "yeast4", "yeast-1-2-8-9_vs_7", "yeast5",
	...
	/**
	 * 评估BalanceStacking分类结果 将多数类划分为多个子类，每个子类赋予新的类标签，将划分后的多类均衡数据集用Stacking学习
	 */
	...
	public static void sumResults() {
		...
		String doc[] = { "VoteMax", "VoteMin", "VoteProduct", "VoteMajority", "VoteAverage", "MaxInverseDistance1",
				"MinInverseDistance1", "ProInverseDistance1", "MajInverseDistance1", "AvgInverseDistance1" };
		// String doc[] ={"EasyEnsemble","RUSBoost"};
		String srcFileName[] = { "nb", "j48", "ripper", "rf", "smo", "ibk" };
		String destFileName[] = { "AUC_Results.xls", "TPR_Results.xls", "TNR_Results.xls", "GMeans_Results.xls",
				"Recall_Results.xls", "Presicion_Results.xls", "FMeasure_Results.xls", "Accuracy_Results.xls",
				"Time_Results.xls" };
		String destSheetName[] = { "Naive Bayes", "J48", "Ripper", "Random Forest", "SMO", "IBk" };
		...
		String column[] = { "data", "yeast3", "ecoli3", "page-blocks0", "ecoli-0-3-4_vs_5", "yeast-2_vs_4",
				"ecoli-0-6-7_vs_3-5", "ecoli-0-2-3-4_vs_5", "glass-0-1-5_vs_2", "yeast-0-3-5-9_vs_7-8",
				"yeast-0-2-5-6_vs_3-7-8-9", "yeast-0-2-5-7-9_vs_3-6-8", "ecoli-0-4-6_vs_5", "ecoli-0-1_vs_2-3-5",
				"ecoli-0-2-6-7_vs_3-5", "glass-0-4_vs_5", "ecoli-0-3-4-6_vs_5", "ecoli-0-3-4-7_vs_5-6",
				"yeast-0-5-6-7-9_vs_4", "vowel0", "ecoli-0-6-7_vs_5", "glass-0-1-6_vs_2", "ecoli-0-1-4-7_vs_2-3-5-6",
		...
		try {
			WritableWorkbook AUC = Workbook.createWorkbook(new File(destPath + destFileName[0]));
			WritableWorkbook TPR = Workbook.createWorkbook(new File(destPath + destFileName[1]));
			WritableWorkbook TNR = Workbook.createWorkbook(new File(destPath + destFileName[2]));
			WritableWorkbook GMeans = Workbook.createWorkbook(new File(destPath + destFileName[3]));
			WritableWorkbook Recall = Workbook.createWorkbook(new File(destPath + destFileName[4]));
			WritableWorkbook Precision = Workbook.createWorkbook(new File(destPath + destFileName[5]));
			WritableWorkbook FMeasure = Workbook.createWorkbook(new File(destPath + destFileName[6]));
			WritableWorkbook Accuracy = Workbook.createWorkbook(new File(destPath + destFileName[7]));
			WritableWorkbook Time = Workbook.createWorkbook(new File(destPath + destFileName[8]));
			...
			for (int k = 0; k < destSheetName.length; k++) {
				...
				WritableSheet sheet6 = Precision.createSheet(destSheetName[k], k);
				WritableSheet sheet7 = FMeasure.createSheet(destSheetName[k], k);
				WritableSheet sheet8 = Accuracy.createSheet(destSheetName[k], k);
				...
				for (int i = 0; i < doc.length; i++) {
					String srcFile = srcPath + doc[i] + "//" + srcFileName[k] + ".csv";
					CsvReader reader = new CsvReader(srcFile);
					int row = 1;
					while (reader.readRecord()) {
						sheet1.addCell(new Number(i + 1, row, Double.parseDouble(reader.get(1))));
						sheet2.addCell(new Number(i + 1, row, Double.parseDouble(reader.get(2))));
						sheet3.addCell(new Number(i + 1, row, Double.parseDouble(reader.get(3))));
						sheet4.addCell(new Number(i + 1, row, Double.parseDouble(reader.get(4))));
						sheet5.addCell(new Number(i + 1, row, Double.parseDouble(reader.get(5))));
						sheet6.addCell(new Number(i + 1, row, Double.parseDouble(reader.get(6))));
						sheet7.addCell(new Number(i + 1, row, Double.parseDouble(reader.get(7))));
						sheet8.addCell(new Number(i + 1, row, Double.parseDouble(reader.get(8))));
						sheet9.addCell(new Number(i + 1, row, Double.parseDouble(reader.get(9))));
						row = row + 1;
					}
				}
			}
	...
	public static void main(String[] args) {
		...
		if (!get_dataset_names(args))
			return; // first get directory and data files

		SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");// 设置日期格式
		System.out.println("START AT" + df.format(new Date()));// new
																// Date()为获取当前系统时间
	...
	//	System.out.println("UnderOverSampling evaluated;" + df.format(new Date()));
		...
		evalRUSBoost();// 14 under-boosting
