...
import weka.attributeSelection.FASTSearch;
...
public class MxNFolds100 {
	...
	private static String[] commonDatasets= {
		"ant-1.3-ckmetrics","ant-1.4-ckmetrics","ant-1.5-ckmetrics","ant-1.6-ckmetrics",
		"camel-1.0-ckmetrics","camel-1.2-ckmetrics","camel-1.4-ckmetrics","camel-1.6-ckmetrics",
		"forrest-0.7-ckmetrics",
		"ivy-2.0-ckmetrics",
		"jedit-3.2-ckmetrics","jedit-4.0-ckmetrics","jedit-4.1-ckmetrics",
		"jedit-4.2-ckmetrics","jedit-4.3-ckmetrics",
		"log4j-1.0-ckmetrics",
		"poi-2.0-ckmetrics",
		"synapse-1.0-ckmetrics","synapse-1.1-ckmetrics","synapse-1.2-ckmetrics",
		"velocity-1.6-ckmetrics",
		"xerces-1.2-ckmetrics","xerces-1.3-ckmetrics",
		"Eclipse_JDT_Core-ckmetrics",
		"Eclipse_PDE_UI-ckmetrics",
		"Equinox_Framework-ckmetrics",
		"Lucene-ckmetrics",
		"Mylyn-ckmetrics"
		};
	private static String commonSourceDir = "D:/database/paper1exp/CKmetrics/";
	private static String commonDestDir = "D:/database/paper1exp/CKresults/test/";
	...
	public static void evalCFSBench() {
		...
		for (int i = 0; i < models.length; i++) {
			...
			for (int j = 0; j < datasets.length; j++) {
				...
				MxNFolds100 mxn = new MxNFolds100();
		...
		for (int i = 0; i < models.length; i++) {
			...
			for (int j = 0; j < datasets.length; j++) {
				...
				try {
					...
					content += datasets[j] + "," + mxn.crossValidate(smote);
				} catch (Exception e) {
					e.printStackTrace();
				}
				long time = System.currentTimeMillis() - timeStart;
	...
	public static void main(String[] args) {
		...
		evalOverBoosting();//gyc
		System.out.println("evalOverBoosting();"+df.format(new Date()));
		
		evalUnderOverBoosting();//gyc
		System.out.println("evalUnderOverBoosting();"+df.format(new Date()));
