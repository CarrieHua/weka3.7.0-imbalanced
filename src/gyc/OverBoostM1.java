...
public class OverBoostM1 
   ...
   * @return
   */
  protected Instances randomSampling(Instances copia, int majC, int minC, int nMaj, int nMin, Random simplingRandom) {
  ...
  public static void main(String [] argv) {
    runClassifier(new OverBoostM1(), argv);
  }
}
