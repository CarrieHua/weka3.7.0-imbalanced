...
public class MxNFolds100old {
	...
	private static String[] commonDatasets= {
		"ant-1.3-allm","ant-1.4-allm","ant-1.5-allm","ant-1.6-allm",
		"camel-1.0-allm","camel-1.2-allm","camel-1.4-allm","camel-1.6-allm",
		"forrest-0.7-allm",
		"ivy-2.0-allm",
		"jedit-3.2-allm","jedit-4.0-allm","jedit-4.1-allm",
		"jedit-4.2-allm","jedit-4.3-allm",
		"log4j-1.0-allm",
		"poi-2.0-allm",
		"synapse-1.0-allm","synapse-1.1-allm","synapse-1.2-allm",
		"velocity-1.6-allm",
		"xerces-1.2-allm","xerces-1.3-allm",
		"Eclipse_JDT_Core-allm",
		"Eclipse_PDE_UI-allm",
		"Equinox_Framework-allm",
		"Lucene-allm",
		"Mylyn-allm"
		};
	private static String commonSourceDir = "D:/database/paper1exp/combineMETRICS/";
	private static String commonDestDir = "D:/database/paper1exp/combineMETRICSresults/cfs100/";	
	
	public MxNFolds100old() {
		m_Data = null;
		m_folds = 10;
		m_repeat = 10;
	}	
	...
	public static void evalCFSBench() {
		...
		for (int i = 0; i < models.length; i++) {
			...
			for (int j = 0; j < datasets.length; j++) {
				...
				MxNFolds100old mxn = new MxNFolds100old();
